                ...
                BlocBuilder<PinjamanCubit, PinjamanModel>(
                  ...
                  return BlocBuilder<ListPengembalianCubit,
                    ...
                    contextPengembalian
                        ...
                        .fetchData(id_user);
                    return BlocBuilder<SaldoCubit, SaldoModel>(
                                    ...
                                    Row(
                                      children: [
                                        IconButton(
                                            ...
                                            onPressed: () {
                                              Navigator.pushNamed(
                                                  context, '/notifikasi',arguments: id_user);
                                            },
                                            icon:
                                                    ...
                                                    showDialog(
                                                        ...
                                                        builder: (BuildContext
                                                          ...
                                                          return AlertDialog(
                                                            ...
                                                            actions: [
                                                              int.parse(profile.saldo_dana) > int.parse(pinjaman.total_pinjaman)
                                                                  ? ElevatedButton(
                                                                      onPressed:
                                                                          () {
                                                                        insertPembayaran(
                                                                            int.parse(pinjaman.total_pinjaman),
                                                                            int.parse(pinjaman.id_investasi),
                                                                            int.parse(pinjaman.id_investor));
